	...
	**/
	...
	export class Grid<T extends SlickData> {
		...
		**/
		...
		/**
		 * Returns an array of the widths of the columns
		 * @return
		 */
		...
		**/
		 ...
		 * 
		 */
		public editActiveCell(editor?: Editors.Editor<T>, preClickModeOn?: boolean): void;
		...
		**/
		...
		public getScrollbarDimensions(): Dimension;
